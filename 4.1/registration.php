...
if (empty($errors)) {
    ...
    try {
    $conn = new PDO("mysql:host=localhost;dbname=musicdb", "root", "");
    $sql = "INSERT INTO imports (cus_id, cus_name, cus_email, cus_pass, cus_country, cus_city, cus_contact, cus_address) VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
